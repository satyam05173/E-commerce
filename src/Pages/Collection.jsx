...
const Collection = () => {
  ...
  const [flterProducts, setflterProducts] = useState([]);
  ...
  let fpCopy=flterProducts.slice();
  switch(sortType)
  {
    case 'low-high':
      setflterProducts(fpCopy.sort((a,b)=>(a.price-b.price)));
      break;
      case 'high-low':
      setflterProducts(fpCopy.sort((a,b)=>(b.price-a.price)));
      break;
      default:
        applyfilter();
        break;
